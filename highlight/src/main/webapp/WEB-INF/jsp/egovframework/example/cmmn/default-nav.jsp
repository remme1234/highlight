...
<div class="navbar navbar-inverse navbar-fixed-top bs-docs-nav" role="banner">
	<div class="container">
		...
		<div class="navbar-header">
			...
			<a href="#" onclick="pageSubmitFn('main','main')" class="navbar-brand">메트로 <span class="bold">King</span></a>
		</div>
		...
		<nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">     
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown">            
					...
					<li><a href="#" onclick="pageSubmitFn('page1','login')"><i class="fa fa-power-off"></i> Logout</a></li>
					</ul>
				</li>
			</ul>
			<!-- Notifications -->
